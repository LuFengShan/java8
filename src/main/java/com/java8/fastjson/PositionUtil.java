...
public class PositionUtil {
	...
	public static GpsDome gps84_To_Gcj021(String type, double lat, double lon) {
		if (outOfChina(lat, lon)) {
			return null;
		}
		double dLat = transformLat(lon - 105.0, lat - 35.0);
		...
		double mgLat = lat + dLat;
		double mgLon = lon + dLon;
		return new GpsDome(type, mgLat, mgLon);
	}
	...
	public static Gps Gps84_To_bd09(double lat, double lon) {
		...
		return PositionUtil.gcj02_To_Bd09(gcj02.getWgLat(), gcj02.getWgLon());
	}
