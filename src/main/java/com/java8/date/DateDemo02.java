...
public class DateDemo02 {
    ...
    public void yearMonthTest() {
        ...
        System.out.println(String.format("月 年：%s", s));
        s = ym.format(DateTimeFormatter.ofPattern("yyyy-MM"));
        System.out.println(String.format("年-月：%s", s));

        // 获取特定域（年月）
        YearMonth y = YearMonth.now();
        long l1 = y.get(ChronoField.YEAR);
        System.out.println(String.format("年：%s", l1));
        long l2 = y.get(ChronoField.MONTH_OF_YEAR);
        System.out.println(String.format("月：%s", l2));
    ...
    public void ss() {
        ...
        String date1 = formatDate.split(" ")[0];
        String s = LocalDate.now().toString();
        System.out.println(date1);
        System.out.println(s);
        System.out.println(Objects.equals(date1, s));
